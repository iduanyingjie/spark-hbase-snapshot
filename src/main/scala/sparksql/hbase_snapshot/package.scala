...
package object hbase_snapshot {
  ...
  private[hbase_snapshot] abstract class SchemaField extends Serializable
  ...
  private[hbase_snapshot] val SPARK_SQL_TABLE_SCHEMA  = "sparksql.table.schema"
  private[hbase_snapshot] val HBASE_ZOOKEEPER_QUORUM  = HConstants.ZOOKEEPER_QUORUM
  private[hbase_snapshot] val HBASE_TABLE_NAME        = "hbase.table.name"
  private[hbase_snapshot] val HBASE_TABLE_SCHEMA      = "hbase.table.schema"
  private[hbase_snapshot] val HBASE_ROOTDIR           = "hbase.rootdir"
  private[hbase_snapshot] val HBASE_SNAPSHOT_VERSIONS = "hbase.snapshot.versions"
  private[hbase_snapshot] val HBASE_SNAPSHOT_PATH     = "hbase.snapshot.path"
  private[hbase_snapshot] val HBASE_SNAPSHOT_NAME     = "hbase.snapshot.name"

  private[hbase_snapshot] val defaultSnapshotVersions = "3"
  private[hbase_snapshot] val defaultHBaseRootDir     = "/hbase"
